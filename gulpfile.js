...
gulp.task('clean', function (cb) {
  return gulp.src([
        ...
        //path.join(config.dest, 'i'),
        path.join(config.dest, 'views'),
        path.join(config.dest, 'noaccess'),
      ], { read: false })
     .pipe(rimraf());
});
...
gulp.task('html', function() {
  ...
  gulp.src(['./src/views/**/*', './src/noaccess/**/*'], {base:'src'})
...
gulp.task('php', function() {
  gulp.src(['./*/.htaccess'], {base:'src', dot: true})
  .pipe(gulp.dest(config.dest));
  
  gulp.src(['./src/index.php','src/php/**/*'], {base:'src', dot: true })
  .pipe(gulp.dest(config.dest));
});


gulp.task('libAssist', function() {
...
gulp.task('js', function() {
    streamqueue({ objectMode: true },
        ...
        //,gulp.src(['src/views/partials/*.html']).pipe(templateCache({ module: 'soanFashionImage' }))     
    )
...
gulp.task('watch', function () {
  ...
  gulp.watch(['./src/php/*.php', './src/php/**/*.conf', './src/index.php'], ['php']);
...
gulp.task('build', function(done) {
  var tasks = ['html', 'php', 'fonts', 'images', 'less', 'js', 'libAssist'];
